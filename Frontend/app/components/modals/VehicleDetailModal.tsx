  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
        <DialogContent 
          className="max-w-6xl w-[95vw] h-[90vh] p-0 bg-zinc-950 border-white/10 overflow-hidden"
        ...
        >
          ...
          {/* Header */}
          <div className="sticky top-0 z-10 flex items-center justify-between p-4 border-b border-white/10 bg-zinc-950/95 backdrop-blur-sm">
          ...
          <div className="overflow-y-auto h-[calc(90vh-65px)] p-4 md:p-6">
            ...
            <div className="relative w-full aspect-video md:aspect-[21/9] rounded-xl overflow-hidden bg-zinc-900 mb-6 group">
              {vehicle.images.length > 0 ? (
                <>
                  ...
                  {vehicle.images[currentImageIndex].isNftImage && (
                    <div className="absolute top-4 right-4 bg-primary text-black text-xs font-bold px-2 py-1 rounded">
                      NFT Image
                    </div>
                  )}
                  ...
                  {/* Image Counter */}
                  <div className="absolute top-4 left-4 bg-black/60 px-2 py-1 rounded text-xs text-white font-mono">
                        ...
                        {sponsorSlots.map((slot) => (
                          <div key={slot.id} className="aspect-square">
                            {slot.isAvailable ? (
                              ...
                              >
                                <Plus className="w-3 h-3 md:w-4 md:h-4 text-zinc-500 group-hover:text-yellow-500" />
                                <span className="text-[8px] text-zinc-600 group-hover:text-yellow-500/80 hidden md:block">
                                  #{slot.id}
                                </span>
                              </button>
                            ) : (
                              <div className="w-full h-full rounded-lg border border-white/10 bg-zinc-900 overflow-hidden">
                                {slot.sponsor?.logo ? (
                                  <Image
              ...
              <div className="space-y-6">
                ...
                {!vehicle.isUpgraded && isOwner && (
                  <Card className="bg-gradient-to-br from-primary/20 to-yellow-500/10 border-primary/30">
                    <CardContent className="p-6 text-center">
                      ...
                      <Button className="bg-primary hover:bg-primary/90 text-black font-bold w-full">
                        Start Upgrade ($150)
                      </Button>
                    </CardContent>
                  </Card>
                ...
                {vehicle.carToken && (
                  <Card className="bg-black/40 border-white/10">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div className="p-3 bg-zinc-900/50 rounded-lg border border-white/5">
                          ...
                          <div className={cn(
                            ...
                            vehicle.carToken.change24h >= 0 ? "text-green-500" : "text-red-500"
                          )}>
                      ...
                      {/* Chart Placeholder */}
                      <div className="p-4 bg-zinc-900/30 rounded-lg border border-dashed border-white/10 text-center mb-4">
                        <BarChart3 className="w-6 h-6 text-zinc-600 mx-auto mb-1" />
                        <p className="text-xs text-zinc-500">Chart coming soon</p>
                      </div>

                      <div className="flex gap-2">
                        <Button className="flex-1 bg-primary hover:bg-primary/90 text-black font-bold text-sm">
                ...
                <Card className="bg-black/40 border-white/10">
                  <CardHeader className="pb-2">
                    ...
                    <p className="text-xs text-zinc-400">Posts featuring this vehicle</p>
                  </CardHeader>
                  <CardContent>
